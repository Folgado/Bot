...
export declare abstract class Question implements Api.GoogleActionsV2ExpectedIntent {
    intent: Intent;
    inputValueData: QuestionData;
    constructor(intent: Intent);
    data<TValueSpec>(type: InputValueSpec, spec: TValueSpec): void;
}
export declare abstract class SoloQuestion extends Question {
}
