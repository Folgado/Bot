...
exports.attach = (service, options) => {
    ...
    const standard = (body, headers) => __awaiter(this, void 0, void 0, function* () {
        const log = app.debug ? common_1.info : common_1.debug;
        log('Request', common_1.stringify(body));
        log('Headers', common_1.stringify(headers));
        const response = yield handler(body, headers);
        log('Response', common_1.stringify(response.body));
    ...
    const omni = (...args) => {
        for (const framework of common_1.values(app.frameworks)) {
