Arguments: 
  /Users/shuyangc/.nvm/versions/node/v9.2.0/bin/node /Users/shuyangc/.nvm/versions/node/v9.2.0/bin/yarn build

PATH: 
  /anaconda3/bin:/Users/shuyangc/.cargo/bin:/Users/shuyangc/.nvm/versions/node/v9.2.0/bin:/Users/shuyangc/Library/Android/sdk/platform-tools:/Users/shuyangc/bin:/usr/local/bin:/anaconda/bin:/Users/shuyangc/.cargo/bin:/usr/local/git/current/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/sbin:/usr/sbin:/sbin:/usr/local/share/dotnet:/opt/X11/bin:/Library/Frameworks/Mono.framework/Versions/Current/Commands:/Applications/Wireshark.app/Contents/MacOS:/anaconda3/bin:/Users/shuyangc/.cargo/bin:/Users/shuyangc/Library/Android/sdk/platform-tools:/Users/shuyangc/bin:/anaconda/bin
...
npm manifest: 
  {
    ...
    "scripts": {
      "lint": "tslint -p .",
      "clean": "rm -rf dist util plugin",
      "clean:pack": "rm -f *.tgz",
      "build": "concurrently -r \"npm run build:root\" && \"npm run build:util\"",
      "build:root": "tsc",
      "build:util": "cd src/util && tsc",
      "build:watch": "concurrently -rk \"yarn build:watch:root\" \"yarn build:watch:util\"",
      "build:watch:root": "tsc -w",
      "build:watch:util": "cd src/util && tsc -w",
      "build:clean": "yarn clean:pack && yarn clean && yarn build",
      "package": "yarn build:clean && yarn pack",
      "test": "yarn build:clean && ava --fail-fast",
      "test:watch": "yarn build:clean && concurrently -rk \"yarn build:watch\" \"ava -w --fail-fast\"",
      "sync:js:facts-about-google": "cd samples/js/app/facts-about-google/functions && yarn setup",
      "sync:js:name-psychic": "cd samples/js/app/name-psychic/functions && yarn setup",
      "sync:ts:facts-about-google": "cd samples/ts/app/facts-about-google/functions && yarn setup",
      "sync:ts:name-psychic": "cd samples/ts/app/name-psychic/functions && yarn setup",
      "deploy:js:facts-about-google": "cd samples/js/app/facts-about-google/functions && yarn setup && yarn deploy",
      "deploy:js:name-psychic": "cd samples/js/app/name-psychic/functions && yarn setup && yarn deploy",
      "deploy:ts:facts-about-google": "cd samples/ts/app/facts-about-google/functions && yarn setup && yarn deploy",
      "deploy:ts:name-psychic": "cd samples/ts/app/name-psychic/functions && yarn setup && yarn deploy",
      "samples": "yarn sync:js:facts-about-google && yarn sync:js:name-psychic && yarn sync:ts:facts-about-google && yarn sync:ts:name-psychic"
    },
    "repository": {
      "type": "git",
...
Trace: 
  ...
  Exit code: 127
  Command: sh
  Arguments: -c concurrently -r "npm run build:root" && "npm run build:util"
  Directory: /Users/shuyangc/Code/aoglib2
  Output:
  
      at ProcessTermError.MessageError (/Users/shuyangc/.nvm/versions/node/v9.2.0/lib/node_modules/yarn/lib/cli.js:186:110)
      at new ProcessTermError (/Users/shuyangc/.nvm/versions/node/v9.2.0/lib/node_modules/yarn/lib/cli.js:226:113)
      at ChildProcess.<anonymous> (/Users/shuyangc/.nvm/versions/node/v9.2.0/lib/node_modules/yarn/lib/cli.js:30281:17)
